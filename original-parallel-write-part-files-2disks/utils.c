...
void DumpSliceFile_Parallel_Nofor(int sx, int sy, int sz,
		   float *arrP, SlicePtr p, int it, int *diskid) {
...
//PPL  int ix, iy, iz;
  ...
  // if (0 == *diskid) {
  //   strcpy(diskpath, "/home/gfreytag/mnt/hdd/");
  //   // strcpy(diskpath, "/tmp/tti-tmp/");
  //   *diskid = 1;
  // } else {
  //   strcpy(diskpath, "/home/gfreytag/mnt/hdd2/");
  //   // strcpy(diskpath, "/home/gfreytag/mnt/ssd/");
  //   *diskid = 0;
  // }
  ...
  if (0 == *diskid) {
    ...
    *diskid = 1;
    ...
    if (getenv("DISKP2") != NULL) {
      strcpy(diskpath, getenv("DISKP2"));
    } else {
      strcpy(diskpath, "./");
    }
    *diskid = 0;
